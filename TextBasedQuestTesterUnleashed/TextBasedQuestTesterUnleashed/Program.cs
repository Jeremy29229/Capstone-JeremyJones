...
namespace TextBasedQuestTesterUnleashed
{
	class Program
	{
		...
		public static void CreateTextGameQuests()
		{
			...
			JoesDialog[0].GetResponseByText("Need").Requirement = farmersAid.StartingNode.info.MakeQuestRequirement(QuestObjectState.NotStarted);
			...
			RicksDialog[0].GetResponseByText("Just").Requirement = new QuestRequirement(farmersAid.CurrentNode.info, QuestObjectState.InProgress);
			...
			OddsDialog[0].GetResponseByText("Are").Requirement = new QuestRequirement(oddSack.CurrentNode.info, QuestObjectState.InProgress);
			...
			WL[0].GetResponseByText("Of course").Requirement = new QuestRequirement(wolfQuest2014.CurrentNode.info, QuestObjectState.InProgress);
