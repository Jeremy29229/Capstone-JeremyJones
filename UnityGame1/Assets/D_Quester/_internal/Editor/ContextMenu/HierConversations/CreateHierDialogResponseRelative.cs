...
namespace D_Quester
{
	public class CreateHierDialogResponseRelative : ScriptableObject
	{
		[MenuItem("D_Quester/HierConversations/Create HierDialogResponse Relative", false, 4)]
		public static void ShowWindow()
		{
			...
			Undo.RegisterCreatedObjectUndo(neoConversation, "Created HierDialogResponse");
			...
			neoConversation.name = "HierDialogResponse";
			neoConversation.AddComponent<HierDialogResponse>();
